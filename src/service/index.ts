 ...
 * @LastEditTime: 2024-04-01 15:10:26
 * @Description:
 */
...
export default {
    get<T>(url: string, params?: T, config?: AxiosRequestConfig): Promise<AxiosResponse<T>> {
        return axios.get(url, { params })
    },
    post<T>(url: string, data?: T, config?: AxiosRequestConfig): Promise<AxiosResponse<T>> {
        return axios.post(url, data)
    },
    put<T>(url: string, data?: T, config?: AxiosRequestConfig): Promise<AxiosResponse<T>> {
